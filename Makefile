...
pkglibexecdir = $(libexecdir)/md5-engine
...
am_libhw_engine_la_OBJECTS = hw_engine.lo hw_sha.lo hw_sm1.lo \
	hw_sm234.lo hw_aes.lo hw_rsa.lo hw_rand.lo
...
ACLOCAL = ${SHELL} /root/hw_engine/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/hw_engine/missing autoconf
AUTOHEADER = ${SHELL} /root/hw_engine/missing autoheader
AUTOMAKE = ${SHELL} /root/hw_engine/missing automake-1.14
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/hw_engine/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE = md5-engine
PACKAGE_BUGREPORT = 
PACKAGE_NAME = md5-engine
PACKAGE_STRING = md5-engine 1.0
PACKAGE_TARNAME = md5-engine
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
...
STRIP = strip
VERSION = 1.0
abs_builddir = /root/hw_engine
abs_srcdir = /root/hw_engine
abs_top_builddir = /root/hw_engine
abs_top_srcdir = /root/hw_engine
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/hw_engine/install-sh
...
include ./$(DEPDIR)/hw_aes.Plo
include ./$(DEPDIR)/hw_engine.Plo
include ./$(DEPDIR)/hw_rand.Plo
include ./$(DEPDIR)/hw_rsa.Plo
include ./$(DEPDIR)/hw_sha.Plo
include ./$(DEPDIR)/hw_sm1.Plo
include ./$(DEPDIR)/hw_sm234.Plo
